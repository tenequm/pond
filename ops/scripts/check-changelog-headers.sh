...
# (release-plz git_release_body default), so a hand-edit that drops the emoji
# headers silently de-styles the GitHub release. This is the only check that
# stops that before it ships.
set -euo pipefail
