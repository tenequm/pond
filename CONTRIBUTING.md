...
The most wanted contribution. The full playbook is [`skills/pond-add-adapter/SKILL.md`](skills/pond-add-adapter/SKILL.md) - loadable as the `/pond-add-adapter` skill in Claude Code or Codex once [kasetto](https://github.com/pivoshenko/kasetto) installs it (`kst sync`), readable as a document by anyone. The short form:
