...
## Adapter checklist
- [ ] `docs/knowledge/adapters/<name>.md`: 11-row decision table with evidence per row, a field-history section, a `Verified against` line, and a frontmatter `verified` event carrying the date
