...
//   cp "$FIX/generate-fixtures.mjs" .   # node resolves imports next to the script
//   rm -rf "$FIX/sessions"
//   node generate-fixtures.mjs "$FIX"
//
...
if (!out) {
	console.error("usage: node generate-fixtures.mjs <fixture-dir>");
	process.exit(1);
}
...
// The hashed bucket omp derives from the canonical cwd: <scope>-<basename>-<sha256(cwd)>.
