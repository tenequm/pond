...
description: Pond ingests every AI agent session - Claude Code, Codex, OpenCode, OpenClaw, oh-my-pi, Claude Desktop, Claude.ai, Pi, Letta Code, Grok, Hermes, nanoclaw - losslessly into storage you own, then makes the whole corpus searchable and SQL-queryable over MCP. One Rust binary, Lance-backed, local by default.
---
...
# Windows: scoop bucket add tenequm https://github.com/tenequm/scoop-bucket; scoop install pond
pond init   # guided setup
pond sync   # ingest and index
```

  <p style={{ fontSize: '0.875rem', opacity: 0.55, margin: 0 }}>Works with Claude Code · Codex CLI · OpenCode · OpenClaw · oh-my-pi · Claude Desktop · Claude.ai · Pi · Letta Code · Grok · Hermes · nanoclaw</p>

  <p style={{ fontSize: '0.875rem', opacity: 0.55, margin: 0 }}>Runs on macOS · Linux · Windows - <a href="/get-started/install">all install options</a></p>
