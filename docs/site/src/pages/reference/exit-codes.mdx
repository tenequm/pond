---
description: pond exit codes for scripting and CI - branch on codes (0 success, 2 SQL/URL errors, 3-6 storage and copy failures, 75 memory-ceiling stop) instead of parsing output text.
---
